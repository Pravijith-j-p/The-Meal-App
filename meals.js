...
// it fetches meals from API and returns it
            ...
            data.meals.forEach((element) => {
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            ...
                            <button id="main${element.idMeal}" class="btn btn-outline-dark active" onclick="addRemoveToFavList(${element.idMeal})" style="border-radius:50%"><i class="fa-solid fa-heart" style="color: #ed071e;"></i></button>
                        </div>
                    </div>
                </div>
                `;
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-dark" onclick="showMealDetails(${element.idMeal})">More Details</button>
                            <button id="main${element.idMeal}" class="btn btn-outline-dark" onclick="addRemoveToFavList(${element.idMeal})" style="border-radius:50%"><i class="fa-solid fa-heart" style="color: #ed071e;"></i></button>
                        </div>
                    </div>
                </div>
                `;
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            ...
                            <button id="main${data.meals[0].idMeal}" class="btn btn-outline-dark active" onclick="addRemoveToFavList(${data.meals[0].idMeal})" style="border-radius:50%"><i class="fa-solid fa-heart" style="color: #ed071e;"></i></button>
                        </div>
                    </div>
                </div>
                `;
...
// it adds and removes meals to favourites list
function addRemoveToFavList(id) {
    ...
    // Call the function to update the favorites bar
    showFavMealList();
}
